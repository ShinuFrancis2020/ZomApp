import 'package:zoomproject/pages/homepage.dart';
...
import 'package:zoomproject/pages/homescreen.dart';
...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  String meetingName = "test meet";
  String passcode = "101010";
  String meetingDate = "4/19/2023";
  String meetingTime = "2.44 pm";
  String meetingMeridiem = "82";
  String meetingTimezone = "Indian";
  var attend = [];
  var hostusers = [];
  ...
  @override
  void initState() {
    nameController.text = "aju";
    codeController.text = "aju";
    dateController.text = "4/19/2023";
    timeController.text = "3.40";
    this.getContacts();
    this.getTimezone();
  }
